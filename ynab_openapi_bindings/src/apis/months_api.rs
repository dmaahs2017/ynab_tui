...
pub fn get_budget_month(configuration: &configuration::Configuration, budget_id: &str, month: String) -> Result<crate::models::MonthDetailResponse, Error<GetBudgetMonthError>> {
...
pub fn get_budget_months(configuration: &configuration::Configuration, budget_id: &str, last_knowledge_of_server: Option<i64>) -> Result<crate::models::MonthSummariesResponse, Error<GetBudgetMonthsError>> {
    let local_var_configuration = configuration;
