...
pub struct Category {
    ...
    pub original_category_group_id: Option<uuid::Uuid>,
    ...
    /// The day of the goal
    #[serde(rename = "goal_day", skip_serializing_if = "Option::is_none")]
    pub goal_day: Option<i32>,
    /// The goal cadence
    #[serde(rename = "goal_cadence", skip_serializing_if = "Option::is_none")]
    pub goal_cadence: Option<i32>,
    /// The goal cadence frequency
    #[serde(rename = "goal_cadence_frequency", skip_serializing_if = "Option::is_none")]
