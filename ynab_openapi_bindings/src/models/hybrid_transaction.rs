...
impl HybridTransaction {
    pub fn new(id: String, date: String, amount: i64, cleared: Cleared, approved: bool, account_id: uuid::Uuid, deleted: bool, r#type: RHashType, account_name: String) -> HybridTransaction {
        HybridTransaction {
            id,
            date,
            amount,
