...
pub mod save_transaction_with_id;
pub use self::save_transaction_with_id::SaveTransactionWithId;
pub mod save_transaction_with_id_all_of;
pub use self::save_transaction_with_id_all_of::SaveTransactionWithIdAllOf;
