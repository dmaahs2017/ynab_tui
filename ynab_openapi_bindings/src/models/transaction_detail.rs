...
pub struct TransactionDetail {
    ...
    #[serde(rename = "import_payee_name", skip_serializing_if = "Option::is_none")]
    pub import_payee_name: Option<String>,
    /// If the transaction was imported, the original payee name as it appeared on the statement
    #[serde(rename = "import_payee_name_original", skip_serializing_if = "Option::is_none")]
    pub import_payee_name_original: Option<String>,
    /// If the transaction is a debt/loan account transaction, the type of transaction
    #[serde(rename = "debt_transaction_type", skip_serializing_if = "Option::is_none")]
...
impl TransactionDetail {
    pub fn new(id: String, date: String, amount: i64, cleared: Cleared, approved: bool, account_id: uuid::Uuid, deleted: bool, account_name: String, subtransactions: Vec<crate::models::SubTransaction>) -> TransactionDetail {
        TransactionDetail {
            id,
            date,
            amount,
